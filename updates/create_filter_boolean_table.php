...
/**
 * Create the FilterBoolean DB scheme.
 */
class CreateFilterBooleanTable extends \October\Rain\Database\Updates\Migration
{
	/**
	...
	public function up()
	{
		...
		\Schema::create('axc_framework_filter_boolean', function($table)
		{
